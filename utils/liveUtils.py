...
def getShonyaSymbol(strike, exp_date, type):
    ...
    return Utils.parameters[0]["index"] + expDate + type[
        0] + strike if Utils.parameters[0]["index"] not in ["SENSEX", "BANKEX"] else Utils.parameters[0][
                                                                                         "index"] + exp_date + strike + type
